...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='vgg19_model', help='The directory where the pre-trained model was saved')
    ...
    parser.add_argument('--output', typoutput=str, default='output/result.jpg', help='File path of output image', required = True)
